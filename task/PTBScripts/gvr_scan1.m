...
%                                                         %
    ...
    Primes = [zeros(1,50),ones(1,50),2*ones(1,50)];
    Primes = Primes(randperm(150));
    save(fullfile(homepath, 'SubjectData',num2str(PTBParams.subjid), 'TrialOrder.mat'),'Food','Primes')
